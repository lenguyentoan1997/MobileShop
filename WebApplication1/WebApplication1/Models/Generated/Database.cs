...
//     Connection String:      `Data Source=DESKTOP-FBQCESN;Initial Catalog=ShopOnline;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace ShopOnlineConnection
{
    ...
    public partial class SanPham : ShopOnlineConnectionDB.Record<SanPham>  
    {
		...
		[Column] public int? LikeProduct { get; set; }
		[Column] public byte? AveragePoint { get; set; }
	}
